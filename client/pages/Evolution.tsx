        ...
        <div className="p-4 md:p-8 max-w-4xl mx-auto">
          <div className="bg-blue-50 rounded-2xl p-8 text-center">
            ...
            <p className="text-gray-600 mb-4">
              Acesse a aba Perfil para registrar suas primeiras medições e começar a acompanhar sua evolução.
            </p>
          </div>
        </div>
      </Layout>
      ...
      <div className="p-4 md:p-8 max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          <div className="bg-white rounded-2xl shadow-lg p-6 border-2 border-blue-200">
            <p className="text-gray-600 font-semibold text-sm mb-2">Peso Atual</p>
            <p className="text-4xl font-bold text-gray-800">{summary.currentWeight}kg</p>
            <p
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 border-2 border-purple-200">
            <p className="text-gray-600 font-semibold text-sm mb-2">Gordura Corporal</p>
            <p className="text-4xl font-bold text-gray-800">{summary.currentFat}%</p>
            <p
              className={`text-sm font-semibold mt-2 ${
                summary.fatChange < 0 ? 'text-green-600' : 'text-red-600'
              }`}
            >
              {summary.fatChange > 0 ? '+' : ''}{summary.fatChange.toFixed(1)}%
            </p>
          </div>

          <div className="bg-white rounded-2xl shadow-lg p-6 border-2 border-green-200">
            <p className="text-gray-600 font-semibold text-sm mb-2">Massa Magra</p>
            <p className="text-4xl font-bold text-gray-800">{summary.currentMuscle}kg</p>
            <p
              className={`text-sm font-semibold mt-2 ${
                summary.muscleChange > 0 ? 'text-green-600' : 'text-red-600'
              }`}
            >
              {summary.muscleChange > 0 ? '+' : ''}{summary.muscleChange.toFixed(1)}kg
            </p>
          </div>
        </div>
        ...
        <div className="space-y-8">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6">
            <h3 className="text-xl font-bold text-gray-800 mb-4">Evolução de Peso</h3>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6">
            <h3 className="text-xl font-bold text-gray-800 mb-4">Composição Corporal</h3>
            <ResponsiveContainer width="100%" height={300}>
              <LineChart data={metrics}>
                <CartesianGrid strokeDasharray="3 3" />
                <XAxis dataKey="date" />
